...
<link rel="stylesheet" href="<%=this.getServletContext().getContextPath()%>/page/manager/assets/css/chosen.css" />
<link rel="stylesheet" href="<%=this.getServletContext().getContextPath()%>/page/manager/assets/css/datepicker.css" />
<link rel="stylesheet" href="<%=this.getServletContext().getContextPath()%>/page/manager/assets/css/bootstrap-timepicker.css" />
<link rel="stylesheet" href="<%=this.getServletContext().getContextPath()%>/page/manager/assets/css/daterangepicker.css" />
<link rel="stylesheet" href="<%=this.getServletContext().getContextPath()%>/page/manager/assets/css/bootstrap-datetimepicker.min.css" />
<!--fonts-->
